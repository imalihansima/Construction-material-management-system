 ...
 */
public class AD_CSMatDetails extends javax.swing.JFrame {
    DBConnection con;
    PreparedStatement ps;
    ResultSet rs;
    
    
    public AD_CSMatDetails() {
        initComponents();
        tupdate();
    }
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        ADMIN_Dashboard c = new ADMIN_Dashboard();
        c.setVisible(true);
        c.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AD_CSMatDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AD_CSMatDetails().setVisible(true);
            }
        });
    }
