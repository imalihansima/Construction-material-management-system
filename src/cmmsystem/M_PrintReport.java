...
public class M_PrintReport extends javax.swing.JFrame {

    public M_PrintReport() {
        initComponents();
    }
    ...
    String lpay;
    String lbalance;
    public M_PrintReport(String subTotal, String pay, String balance, TableModel model) throws PrinterException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(M_PrintReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new M_PrintReport().setVisible(true);
            }
        });
    }
