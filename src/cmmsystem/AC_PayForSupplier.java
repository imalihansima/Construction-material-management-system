...
public class AC_PayForSupplier extends javax.swing.JFrame {
    DBConnection con;
    PreparedStatement ps;
    ResultSet rs;
    DefaultTableModel model =new DefaultTableModel();
  
    public AC_PayForSupplier() {
        initComponents();
        CheckQty();
      //  tupdate();
    }
  ...
  public class Material{
    ...
    private void initComponents() {
        ...
        jTextFieldApprovedId = new javax.swing.JTextField();
        ...
        jLabelMatCode.setText("Approved id");
        ...
        jTextFieldApprovedId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldApprovedIdActionPerformed(evt);
            }
        });
        jTextFieldApprovedId.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextFieldApprovedIdKeyPressed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jTextFieldApprovedId, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextFieldApprovedId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
   ...
   private void CheckQty(){
            String name=jTextFieldApprovedId.getText();
                         ...
                         model.addRow(new Object[]
                                 {
                                  ...
                                  jTextFieldApprovedId.setText("");
                                  jTextFieldMatName.setText("");
                                  jTextFieldPrice.setText("");
                                  jTextFieldQuantity.setText("");
                                  jTextFieldApprovedId.requestFocus();
    ...
    private void request(){
        ...
        String query="insert into cs_approved (date,subtotal,pay,balance) value(?,?,?,?)";
             ...
             try {
                ...
                String query1="insert into cs_approvedmaterial (a_id, mat_id, price, quantity, total) value(?,?,?,?,?)"; 
            ...
            Logger.getLogger(AC_PayForSupplier.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jTextFieldApprovedIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldApprovedIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldApprovedIdActionPerformed
    ...
    private void jTextFieldApprovedIdKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldApprovedIdKeyPressed
    ...
    }//GEN-LAST:event_jTextFieldApprovedIdKeyPressed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AC_PayForSupplier().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldApprovedId;
